 ...
 */
module.exports = function(cookies, clubId, articleNo, boardType, callback){
    var http = require('http');
    var iconv = require('iconv-lite');

    var options = {
        host: 'club.cyworld.com',
        path: '/club/board/common/CommentList.asp?club_id=' + clubId + '&board_type=' + boardType + '&board_no=1&item_seq=' + articleNo,
        method: 'POST',
        headers: {
